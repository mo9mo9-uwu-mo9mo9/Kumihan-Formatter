...
class ImportOptimizer:
    ...
    def _is_import_used(self, import_info: Dict, used_names: Set[str], content: str) -> bool:
        """importが使用されているかチェック"""
    ...
    def _print_summary(self):
        ...
        if self.stats['imports_total'] > 0:
            reduction_rate = (self.stats['imports_removed'] / self.stats['imports_total']) * 100
...
def main():
    ...
    parser.add_argument('--execute', action='store_true',
                       help='実際にimportを削除実行')
    parser.add_argument('--src-dir', default='kumihan_formatter',
