...
from ..common.error_framework import KumihanError, ErrorCategory
...
class CacheStorage:
    ...
    def __init__(self, name: str, max_memory_entries: int, max_memory_bytes: int,
                 strategy: CacheStrategy, cache_dir: Optional[Path] = None,
