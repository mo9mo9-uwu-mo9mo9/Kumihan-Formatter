...
from .error_types import DetailedError, ErrorSeverity, ErrorCategory, ErrorLocation, FixSuggestion
...
class ErrorReportBuilder:
    ...
    def add_syntax_error(self, line: int, message: str, 
                        suggestion: Optional[str] = None) -> 'ErrorReportBuilder':
        """構文エラーを追加"""
        error = DetailedError(
    ...
    def add_keyword_error(self, line: int, keyword: str, 
                         suggestion: Optional[str] = None) -> 'ErrorReportBuilder':
        """キーワードエラーを追加"""
        error = DetailedError(
