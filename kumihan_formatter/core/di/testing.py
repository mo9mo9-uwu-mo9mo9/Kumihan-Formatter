...
from .interfaces import ServiceProvider, ServiceLifetime
...
class DIAssertions:
    ...
    def assert_service_not_registered(container: ServiceProvider, service_type: Type) -> None:
        ...
        assert not container.has_service(service_type), \
            f"Service {service_type.__name__} should not be registered"
    ...
    def assert_same_instance(
        ...
        assert actual_instance is expected_instance, \
            f"Service instance mismatch for {service_type.__name__}"
    ...
    def assert_different_instances(
        ...
        assert instance1 is not instance2, \
            f"Service {service_type.__name__} should return different instances"