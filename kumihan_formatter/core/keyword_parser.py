...
class KeywordParser:
    ...
    def create_compound_block(self, keywords: List[str], content: str, attributes: Dict[str, Any]) -> Node:
        """
    ...
    def _get_keyword_suggestions(self, invalid_keyword: str, max_suggestions: int = 3) -> List[str]:
        ...
        suggestions = get_close_matches(invalid_keyword, all_keywords, n=max_suggestions, cutoff=0.6)
        return suggestions
