...
class ErrorFactory:
    ...
    def create_permission_error(
        file_path: str, operation: str = "アクセス"
    ) -> UserFriendlyError:
        """権限エラー"""
        return UserFriendlyError(
            error_code="E004",
    ...
    @staticmethod
    def create_file_size_error(
        file_path: str, size_mb: float, max_size_mb: float = 10
    ) -> UserFriendlyError:
        """ファイルサイズエラー"""
        return UserFriendlyError(
            error_code="E006",
