...
class PerformanceMonitor:
    ...
    def __init__(self, monitoring_interval: float = 1.0, history_size: int = 1000):
        ...
        self.logger.info(f"PerformanceMonitor initialized: interval={monitoring_interval}s, history={history_size}")
    ...
    def start_monitoring(self, total_items: int, initial_stage: str = "開始"):
        ...
        with self._lock:
            ...
            self.logger.info(f"Performance monitoring started: {total_items} items, stage: {initial_stage}")
    ...
    def stop_monitoring(self):
        ...
        with self._lock:
            ...
            self.logger.info(f"Performance monitoring stopped after {self.stats.duration_seconds:.2f}s")
    ...
    def get_current_snapshot(self) -> PerformanceSnapshot:
        ...
        try:
            ...
            # 現在のステージ
            current_stage = self.stats.processing_phases[-1] if self.stats.processing_phases else "unknown"
            ...
            try:
                ...
                with self._lock:
                    ...
                    if len(self.snapshots) > 0:
                        ...
                        self.stats.avg_cpu_percent = sum(s.cpu_percent for s in recent_snapshots) / len(recent_snapshots)
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                'current_cpu_percent': recent_snapshots[-1].cpu_percent if recent_snapshots else 0,
    ...
    def generate_performance_report(self) -> str:
        ...
        if len(self.snapshots) >= 5:
            ...
            memory_status = "増加" if memory_trend > 0.5 else "安定" if memory_trend > -0.5 else "減少"
            ...
            if rates:
                ...
                rate_status = "向上" if rate_trend > 0.5 else "安定" if rate_trend > -0.5 else "低下"
