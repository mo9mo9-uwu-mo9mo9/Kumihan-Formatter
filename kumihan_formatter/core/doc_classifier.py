...
class DocumentClassifier:
    ...
    def _build_classification_rules(self) -> Dict[DocumentType, Dict[str, List[str]]]:
        ...
        return {
            ...
            DocumentType.DEVELOPER: {
                ...
                "paths": ["dev", "developer", "development", "docs/dev", "docs/developer", "docs/development"],
                "patterns": [r"contribut", r"developer", r"development", r"api", r"architecture"],
            },
            ...
            DocumentType.EXCLUDE: {
                "filenames": ["CHANGELOG.md", "HISTORY.md", "TODO.md", ".gitignore", ".gitattributes"],
                "paths": [".git", ".github", ".vscode", ".idea", "__pycache__", ".pytest_cache", "node_modules"],
                "patterns": [r"changelog", r"history", r"todo", r"\.git", r"__pycache__", r"\.pytest_cache"],
            },
        }
    ...
    def _should_exclude_by_patterns(self, file_path: Path, base_path: Path, patterns: List[str]) -> bool:
        """除外パターンによるチェック"""
