...
from ..common import ErrorContext, KumihanError
...
class BaseValidator(ABC):
    ...
    def get_validation_stats(self) -> Dict[str, int]:
        ...
        """
        return {"validations": self._validation_count, "errors": self._error_count}
...
class BaseParser(ABC, Generic[T]):
    ...
    def get_parse_stats(self) -> Dict[str, int]:
        ...
        """
        return {"parses": self._parse_count, "errors": self._error_count}
