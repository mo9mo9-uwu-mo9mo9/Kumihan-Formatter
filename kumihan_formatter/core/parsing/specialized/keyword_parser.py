...
from ..keyword.parsers.advanced_parser import AdvancedKeywordParser

# 分割されたパーサーをインポート
from ..keyword.parsers.basic_parser import BasicKeywordParser
from ..keyword.parsers.custom_parser import CustomKeywordParser
