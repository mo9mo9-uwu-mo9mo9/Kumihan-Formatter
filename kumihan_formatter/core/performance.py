...
class PerformanceMonitor:
    ...
    @contextmanager
    def measure(self, operation_name: str, node_count: Optional[int] = None, file_size: Optional[int] = None):
...
class PerformanceProfiler:
    ...
    def get_top_functions(self, metric: str = "total_time", limit: int = 10) -> List[tuple]:
        ...
        sorted_functions = sorted(stats.items(), key=lambda x: x[1][metric], reverse=True)
