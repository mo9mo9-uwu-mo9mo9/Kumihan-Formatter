...
class ConfigValidator:
    ...
    SCHEMA = {
        "markers": {
            "type": dict,
            "required": True,
            "schema": {"*": {"type": dict, "required_keys": ["tag"], "optional_keys": ["class", "summary"]}},
        },
        ...
        if expected_type == dict and "schema" in spec:
            ...
            if "*" in schema:
                ...
                for key, value in section_data.items():
                    key_errors, key_warnings = self._validate_section(f"{section_name}.{key}", value, wildcard_spec)
...
class EnhancedConfig:
    ...
    DEFAULT_CONFIG = {
        ...
        "themes": {
            "default": {
                "name": "デフォルト",
                "css": {"background_color": "#f9f9f9", "container_background": "white", "text_color": "#333"},
            },
            "dark": {
                "name": "ダーク",
                "css": {"background_color": "#1a1a1a", "container_background": "#2d2d2d", "text_color": "#e0e0e0"},
            },
            "sepia": {
                "name": "セピア",
                "css": {"background_color": "#f4f1ea", "container_background": "#fdf6e3", "text_color": "#5c4b37"},
            },
            "high-contrast": {
                "name": "ハイコントラスト",
                "css": {"background_color": "#000000", "container_background": "#ffffff", "text_color": "#000000"},
            },
        },
        "performance": {"max_recursion_depth": 50, "max_nodes": 10000, "cache_templates": True},
        "validation": {"strict_mode": False, "warn_unknown_keywords": True, "max_file_size_mb": 10},
    }
