...
class TemplateManager:
    ...
    def select_template_name(
        self, source_text: Optional[str] = None, template: Optional[str] = None, experimental: Optional[str] = None
    ) -> str:
        """
...
class RenderContext:
    ...
    def metadata(self, description: str = None, keywords: str = None) -> "RenderContext":
        """Add page metadata"""
        if description:
...
class TemplateValidator:
    ...
    def validate_template_variables(self, template_name: str, required_vars: list[str]) -> tuple[bool, list[str]]:
        """
