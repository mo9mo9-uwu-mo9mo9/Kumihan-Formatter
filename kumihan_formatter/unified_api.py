...
from .managers import CoreManager, ParsingManager, OptimizationManager, PluginManager, DistributionManager
...
class KumihanFormatter:
    ...
    def __init__(self, config_path: Optional[Union[str, Path]] = None):
        ...
        self.optimization = OptimizationManager(self.core.config if hasattr(self.core, 'config') else None)
    ...
    def convert(
        ...
        try:
            ...
            rendered_content = self.core.render_template(template, {
...
# 便利関数
def quick_convert(input_file: Union[str, Path], output_file: Union[str, Path] = None) -> Dict[str, Any]:
    """クイック変換関数"""
