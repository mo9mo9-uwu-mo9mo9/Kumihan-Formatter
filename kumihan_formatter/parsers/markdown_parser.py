...
from ..core.parsing.specialized.markdown_parser import (
    UnifiedMarkdownParser as CoreMarkdownParser,
)
...
class UnifiedMarkdownParser(MarkdownParserProtocol):
            ...
            for line in lines:
                ...
                if stripped.startswith("#"):
                    ...
                    node = Node(
                        ...
                        attributes={"level": level, "original_line": line},
                    )
                    nodes.append(node)
    ...
    def _create_error_parse_result(
        ...
        return ParseResult(
            ...
            errors=[error_msg],
            warnings=[],
            metadata={"original_content": original_content, "parser_type": "markdown"},
        )
