...
class SampleCommand:
    ...
    def execute(self, output_dir: str = "kumihan_sample", 
                use_source_toggle: bool = False) -> Path:
        """
...
class TestFileCommand:
    ...
    def execute(self, test_output: str, pattern_count: int, double_click_mode: bool,
                output: str, no_preview: bool, show_test_cases: bool, config: str) -> None:
        """
        ...
        self._test_generated_file(
            output_file, output, config, show_test_cases,
            no_preview, double_click_mode
        )
    
    def _test_generated_file(self, output_file: Path, output: str, config: str,
                           show_test_cases: bool, no_preview: bool, double_click_mode: bool) -> None:
        ...
        try:
            ...
            test_output_file = convert_command._convert_file(
                output_file, output or "dist", config_obj,
                show_stats=False, show_test_cases=show_test_cases
            )
...
def create_test_command():
    ...
    def generate_test(test_output, pattern_count, double_click_mode, output, 
                     no_preview, show_test_cases, config):
        """テスト用記法網羅ファイルを生成します"""
        command = TestFileCommand()
        command.execute(
            test_output, pattern_count, double_click_mode,
