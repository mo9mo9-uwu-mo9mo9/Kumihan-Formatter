...
class ConvertProcessor:
    ...
    def convert_file(self, input_path: Path, output_dir: str, config_obj=None,
                    show_test_cases: bool = False, template: Optional[str] = None,
                    include_source: bool = False) -> Path:
        """ファイルを変換してHTMLを生成"""
