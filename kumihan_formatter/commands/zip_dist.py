...
class ZipDistCommand:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if convert_docs:
                ...
                stats = create_user_distribution(
                    source_path, temp_path, convert_docs=True, include_developer_docs=include_developer_docs, ui=ui
                )
    ...
    def _copy_source_files(self, source_path: Path, temp_path: Path, exclude_patterns: list) -> None:
    ...
    def _create_directory_output(self, temp_path: Path, output_path: Path, zip_name: str, no_preview: bool) -> None:
    ...
    def _create_zip_output(self, temp_path: Path, output_path: Path, zip_name: str, no_preview: bool) -> None:
