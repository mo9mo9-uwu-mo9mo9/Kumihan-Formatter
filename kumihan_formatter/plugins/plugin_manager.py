...
from ..core.common import ErrorCategory, KumihanError, get_cache
...
class PluginManager(BaseManager):
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            raise KumihanError("Failed to initialize plugin manager", category=ErrorCategory.SYSTEM, cause=e)
    ...
    def shutdown(self) -> bool:
        ...
        try:
            ...
            raise KumihanError("Failed to shutdown plugin manager", category=ErrorCategory.SYSTEM, cause=e)
    ...
    def load_plugin(
        self, plugin_name: str, config: Optional[Dict[str, Any]] = None, enable_immediately: bool = True
    ) -> KumihanPlugin:
    ...
    def validate_all_plugins(self) -> List[KumihanError]:
        ...
        for plugin in self.registry.get_all_plugins():
            try:
                ...
                errors.append(
                    KumihanError(f"Plugin '{plugin.name}' validation failed", category=ErrorCategory.SYSTEM, cause=e)
                )
