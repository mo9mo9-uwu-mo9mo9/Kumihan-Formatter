...
from ..core.io.distribution.distribution_manager import (
    DistributionManager as CoreDistributionManager,
)
...
class DistributionManager:
    ...
    def __init__(self):
        ...
        self.logger.info(
            "DistributionManager initialized - unified distribution system"
        )
    ...
    def validate_distribution(self, distribution_path: Union[str, Path]) -> bool:
        """配布パッケージ検証"""
        try:
            return self.core_distribution_manager.validate_distribution(
                distribution_path
            )
        except Exception as e:
    ...
    def get_distribution_info(
        self, distribution_path: Union[str, Path]
    ) -> Dict[str, Any]:
        """配布パッケージ情報取得"""
    ...
    def optimize_distribution(
        ...
        """配布パッケージ最適化"""
        try:
            return self.core_distribution_manager.optimize_distribution(
                distribution_path
            )
        except Exception as e:
