...
from ..core.common import LFUStrategy, LRUStrategy, SmartCache, get_cache
...
class CacheServiceImpl(CacheService):
    ...
    def get_all_stats(self) -> Dict[str, Dict[str, Any]]:
        ...
        """
        return {name: cache.get_stats() for name, cache in self._cache_instances.items()}
    ...
    def cache_function(
        self, cache_name: Optional[str] = None, ttl: Optional[int] = None, key_func: Optional[Callable] = None
    ):
