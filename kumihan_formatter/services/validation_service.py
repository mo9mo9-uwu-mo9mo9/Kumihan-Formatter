...
from ..core.common import ErrorCategory, KumihanError, ValidationMixin, ValidationRule
...
class ValidationServiceImpl(ValidationService):
    ...
    def _register_builtin_schemas(self) -> None:
        ...
        config_schema = {
            ...
            "properties": {
                ...
                "cache": {
                    "type": "object",
                    "properties": {"enabled": {"type": "boolean"}, "ttl": {"type": "integer", "minimum": 1}},
                },
                "parser": {
                    "type": "object",
                    "properties": {
    ...
    def _validate_against_schema(self, data: Any, schema_def: Dict[str, Any], schema_name: str) -> List[KumihanError]:
        ...
        try:
            ...
            errors.append(
                KumihanError(
                    f"Validation error for schema '{schema_name}': {e}", category=ErrorCategory.VALIDATION, cause=e
                )
            )
    ...
    def _validate_object_properties(
        self, data: Dict[str, Any], schema_def: Dict[str, Any], schema_name: str
    ) -> List[KumihanError]:
    ...
    def _validate_array_items(
        self, data: List[Any], schema_def: Dict[str, Any], schema_name: str
    ) -> List[KumihanError]:
    ...
    def _validate_string_constraints(
        self, data: str, schema_def: Dict[str, Any], schema_name: str
    ) -> List[KumihanError]:
    ...
    def _validate_number_constraints(
        self, data: Union[int, float], schema_def: Dict[str, Any], schema_name: str
    ) -> List[KumihanError]:
    ...
    def validate_with_rules(self, data: Dict[str, Any], rule_set_name: str) -> List[KumihanError]:
        ...
        if rule_set_name not in self._rule_sets:
            return [KumihanError(f"Unknown rule set: {rule_set_name}", category=ErrorCategory.VALIDATION)]
