...
class ConfigurationServiceImpl(ConfigurationService, ValidationMixin):
    ...
    def _load_defaults(self) -> None:
        ...
        defaults = {
            ...
            "parser": {"strict_mode": False, "max_file_size_mb": 10, "encoding": "utf-8"},
            "renderer": {"output_format": "html", "pretty_print": True, "minify_html": False},
            "plugins": {"auto_load": True, "directories": []},
            "ui": {"color_output": True, "progress_bars": True, "verbose": False},
        }
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        # Add to sources
        self._sources.append({"type": "manual", "data": {key: value}, "timestamp": datetime.now()})
    ...
    def load_from_file(self, file_path: Path) -> bool:
        ...
        try:
            ...
            self._sources.append(
                {"type": "file", "path": str(file_path), "data": file_config, "timestamp": datetime.now()}
            )
