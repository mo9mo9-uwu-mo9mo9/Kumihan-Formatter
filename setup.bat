...
if /i "%choice%"=="y" (
    ...
    if exist "WINDOWS\サンプル実行.bat" (
        ...
        if /i "!convert_choice!"=="y" (
            ...
            if exist "WINDOWS\変換ツール.bat" (
                ...
                echo ❌ エラー: WINDOWS\変換ツール.bat が見つかりません
                echo 手動で WINDOWS\変換ツール.bat をダブルクリックしてください
            )
        )
    ) else (
        echo ❌ エラー: WINDOWS\サンプル実行.bat が見つかりません
    ...
    echo.
    echo 💡 後で使用する場合:
    echo    WINDOWS\変換ツール.bat をダブルクリックしてください
    echo.
    echo 📊 サンプルを確認する場合:
    echo    WINDOWS\サンプル実行.bat をダブルクリックしてください
    echo.
    echo 何かキーを押して終了してください...
    pause > nul
)