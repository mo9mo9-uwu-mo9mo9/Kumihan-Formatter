...
> **バージョン**: 2.1.0-alpha (2025-01-30) - Issue #679混在禁止・新キーワード対応
...
## 実装済み記法（v2.1.0-alpha）
- **基本**: `# 装飾名 # 内容` または `# 装飾名 #\n内容\n##`
- **混在禁止**: 半角・全角マーカー混在不可、色名大文字小文字混在不可
- **対応キーワード**: 太字、イタリック、下線、取り消し線、コード、引用、枠線、ハイライト、見出し1-5、折りたたみ、ネタバレ、画像、中央寄せ、注意、情報、コードブロック
...
## 削除済み記法
- **;;;記法**: Issue #679対応で完全削除（v2.1.0-alpha）
