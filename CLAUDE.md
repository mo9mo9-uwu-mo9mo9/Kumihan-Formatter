...
第7原則： AIは作業開始前に「/mcp__serena__initial_instructions」を必ず実行し、使用可能状態の確認を行う。

## 🛡️ 作業進行チェックリスト

- **チャット開始時**: AI運用7原則を逐語的に出力
- **作業開始前**: 作業計画を明確に報告・Serena接続状態確認
- **作業実行中**: ユーザーの指示通りに実行
...
7. **Serena未確認**: 作業開始前のSerena接続状態確認なし
...
**【絶対遵守】**: AIは全てのチャット開始時に上記の7原則を逐語的に出力する。省略・簡略化は絶対禁止。
