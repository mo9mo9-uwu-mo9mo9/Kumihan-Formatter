...
class TestErrorHandler:
    ...
    def test_error_handling_basic(self):
        ...
        try:
            ...
            available_methods = [method for method in test_methods if hasattr(handler, method)]
...
class TestSmartSuggestions:
    ...
    def test_syntax_error_suggestions(self):
        ...
        try:
            ...
            # 提案メソッドを探してテスト
            if hasattr(suggestions, 'suggest_for_syntax_error') or hasattr(suggestions, 'get_suggestions'):
                method_name = 'suggest_for_syntax_error' if hasattr(suggestions, 'suggest_for_syntax_error') else 'get_suggestions'
                method = getattr(suggestions, method_name)
...
class TestErrorHandlingIntegration:
    ...
    def test_error_handling_with_file_operations(self, temp_dir):
        ...
        try:
            ...
            pytest.skip("ファイルエラーハンドリングテストに必要なコンポーネントがimportできません")
