"""GUI Main Controller Event Handling Tests

Issue #501 Phase 4 GUIテスト復旧 - MainControllerイベント対応
"""
...
class TestMainControllerEvents:
    """MainController event handling tests"""
