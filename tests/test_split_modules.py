...
class TestSplitModulesBasic:
    ...
    def test_document_type_enum(self):
        ...
        assert hasattr(DocumentType, "USER_ESSENTIAL")
        assert hasattr(DocumentType, "USER_GUIDE")
        assert hasattr(DocumentType, "DEVELOPER")
        assert hasattr(DocumentType, "TECHNICAL")
        assert hasattr(DocumentType, "EXCLUDE")
        assert hasattr(DocumentType, "EXAMPLE")
    ...
    def test_node_creation(self):
        """Test Node creation"""
        node = Node("test_type", "test_content")
    ...
    def test_node_builder_creation(self):
        ...
        node = builder.content("test").build()
