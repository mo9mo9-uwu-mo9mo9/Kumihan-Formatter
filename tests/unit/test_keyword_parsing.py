...
from kumihan_formatter.core.keyword_parsing.definitions import KeywordDefinitions, DEFAULT_BLOCK_KEYWORDS, NESTING_ORDER
from kumihan_formatter.core.keyword_parsing.marker_parser import MarkerParser, ParseResult
...
class TestKeywordDefinitions:
    ...
    def test_default_keywords_loaded(self):
        ...
        expected_keywords = ["太字", "見出し1", "見出し2", "下線"]
