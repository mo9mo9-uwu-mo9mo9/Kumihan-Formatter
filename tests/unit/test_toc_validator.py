...
class TestTOCValidator:
    ...
    def test_validate_invalid_level_type(self):
        ...
        entries = [
            self.create_mock_toc_entry("Chapter 1", "invalid", "chapter-1"),  # String instead of int
            self.create_mock_toc_entry("Chapter 2", 1, "chapter-2")
        ]
    ...
    def test_validate_invalid_level_range(self):
        ...
        assert len(result) >= 2
        assert any("level" in error.lower() and ("0" in error or "range" in error.lower()) for error in result)
        assert any("level" in error.lower() and ("7" in error or "range" in error.lower()) for error in result)
    ...
    def test_validate_invalid_id_format(self):
        ...
        entries = [
            self.create_mock_toc_entry("Chapter 1", 1, "invalid id with spaces"),  # Invalid ID format
            self.create_mock_toc_entry("Chapter 2", 1, "chapter-2")
        ]
        ...
        assert len(result) > 0
        assert any("id" in error.lower() and ("format" in error.lower() or "invalid" in error.lower()) for error in result)
    ...
    def test_validate_special_characters_in_title(self):
        ...
        title_errors = [error for error in result if "special" in error.lower() or "character" in error.lower()]
    ...
    def test_validate_unicode_in_ids(self):
        ...
        unicode_errors = [error for error in result if "unicode" in error.lower() or "id" in error.lower()]
